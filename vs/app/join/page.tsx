      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <input
              className="w-full rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 text-sm text-slate-50 uppercase outline-none focus:border-green-400 focus:ring-1 focus:ring-green-400"
              value={code}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full text-sm font-semibold text-green-300 hover:text-green-200 transition disabled:opacity-60"
          >
